...
<div class="avatar-editor"> <!-- Контейнер для редактора аватара и обложки -->
    ...
    <form action="php_form/admin_img_loader.php" method="post" id="ava-form" class="ava-form" enctype="multipart/form-data" style="display: none;"> <!-- Форма для редактора аватара -->
        ...
        <!-- далее идут скрытые поля для передачи данных в php -->
    ...
    <form action="php_form/admin_img_loader_cover.php" method="post" id="cover-form" class="ava-form" enctype="multipart/form-data" style="display: none;"> <!-- Контейнер для редактора обложки -->
