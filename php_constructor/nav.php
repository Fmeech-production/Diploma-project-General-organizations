...
<?php
	...
	##############################################################################################################
	//Начальник отдела хозяйственной части
	##############################################################################################################
} else if ($user['Account-type'] == 1) {    ?> <!-- Если пользователь является начальником отдела хозяйственной части -->
	<nav class="lock"> <!-- Боковое меню -->
		<?php ul::mobailBurger($loc['AS']); ?>
		<ul> <!-- Список ссылок -->
			<?php
...
<?php
	...
	##############################################################################################################
	//Работник отдела хозяйственной части
	##############################################################################################################
} else if ($user['Account-type'] == 2) {    ?> <!-- Если пользователь - Работник отдела хозяйственной части -->
	<nav class="lock"> <!-- Боковое меню -->
		<?php ul::mobailBurger($loc['AS']); ?>
		<ul>
			<?php
